...
def resnet18(pretrained: bool = False, progress: bool = True, strides = [1, 2, 2, 2], **kwargs: Any) -> ResNet:
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], strides, pretrained, progress,
                   **kwargs)
