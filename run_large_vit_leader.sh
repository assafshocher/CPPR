...
loss_var_coeff=25
loss_cov_coeff=383
OUTPUT_DIR="CONTEXTLESS_blr${BLR}_mr${MASK_RATIO}_invar${loss_invar_coeff}_var${loss_var_coeff}_cov${loss_cov_coeff}_batchsize_${batch_size}_vit_64-768-large_8nodes"
python submitit_pretrain.py \
        ...
        --contextless_model_projector_arch 64-768 \
        --weight_decay 0.05 \
