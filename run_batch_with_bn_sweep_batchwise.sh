  ...
  do
    ...
    do
        ...
        do
          ...
          do
              for batch_patch_ratio in 0.25 0.5 1 2 4
                do
                  if ((${COUNTER} > 3)); then
                    partition=learnlab
                  else
                  ...
                  OUTPUT_DIR="CONTEXTLESS_blr${BLR}_mr${MASK_RATIO}_invar${loss_invar_coeff}_var${loss_var_coeff}_cov${loss_cov_coeff}_batchsize_${batch_size}_basenorm_batchwise_${batch_patch_ratio}"
                  python submitit_pretrain.py \
                          ...
                          --use_batch_stats \
                          --batch_patch_ratio ${batch_patch_ratio} \
                          --weight_decay 0.05 \
