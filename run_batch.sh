        ...
        do
          ...
          do
            ...
            do
                ...
                OUTPUT_DIR="CROSS_temp_${TEMPERATURE}_blr_${BLR}_gsz_${GROUP_SZ}_wpred_${W_PRED_LOSS}_wpred_${W_PRED_LOSS}_wbatch_${W_BATCHWISE_LOSS}_wpatch_${W_PATCHWISE_LOSS}${DETACH}"
